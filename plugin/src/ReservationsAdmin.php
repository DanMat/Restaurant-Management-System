...
final class ReservationsAdmin
{
    ...
    private function styles(string $nonce): string
    {
        return '<style nonce="' . self::e($nonce) . '">'
            ...
            . '.rz-form label{display:flex;flex-direction:column;gap:.25rem;flex:1 1 10rem;min-width:0;font-weight:600;font-size:.85rem}'
            . '.rz-form input,.rz-form select,.rz-form textarea{font:inherit;padding:.5rem .6rem;min-height:44px;box-sizing:border-box;width:100%;max-width:100%}'
